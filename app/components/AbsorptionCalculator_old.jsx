...
export default function AbsorptionCalculator({ initialCities = [] }) {
  ...
  // Fetch data for selected city, month and year
  useEffect(() => {
    if (!selectedCity) {
      setData(null);
      setError(null);
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // Find the data for selected month/year
  ...
  const renderResults = () => {
    return (
    <div style={{ width: "100%" }}>
      {/* Calculation Card - Left/Right Layout */}
      ...
      <div className="selectors-card" style={{
        ...
        <div>
          ...
          <select
            ...
            onBlur={(e) => {
              e.target.style.borderColor = selectedCity ? "#0066cc" : "#e0e0e0";
